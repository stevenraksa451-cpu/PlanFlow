...
// Initialiser le client Supabase avec protection anti-redeclaration
window.supabase = window.supabase || {};
const supabase = window.supabase.createClient ? window.supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY) : window.supabaseClient;
...
// Gérer l'affichage initial basé sur le hash de l'URL
...
async function checkSession() {
    try {
        ...
        // Seulement rediriger si on est sur la page de connexion (pas signup)
        if (session && window.location.hash !== '#signup') {
